...
More details at: [data backup and restoration](https://github.com/retoaccess1/haveno-reto/blob/master/docs/backup_restoration.md).
...
Not sure which kind of payment account to set up? There's a full list of [payment methods](https://github.com/retoaccess1/haveno-reto/blob/master/docs/payment_methods.md) on the wiki.
...
To see both sides of a Haveno-reto trade at the same time, side-by-side: be sure to check out our [trading recommendations](https://github.com/retoaccess1/haveno-reto/blob/master/docs/payment_methods.md) and [linked tutorials made by the community](https://haveno-reto.com/#posts).
